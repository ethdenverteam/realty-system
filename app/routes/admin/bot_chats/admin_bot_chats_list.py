"""
Admin bot chats list routes
Логика: получение списка чатов, поиск чатов, загрузка из Telegram
"""
...
admin_bot_chats_list_bp = Blueprint('admin_bot_chats_list', __name__)
logger = logging.getLogger(__name__)

@admin_bot_chats_list_bp.route('/dashboard/bot-chats', methods=['GET'])
@jwt_required
@role_required('admin')
...
@admin_bot_chats_list_bp.route('/dashboard/bot-chats/list', methods=['GET'])
@jwt_required
@role_required('admin')
...
@admin_bot_chats_list_bp.route('/dashboard/bot-chats', methods=['POST'])
@jwt_required
@role_required('admin')
...
@admin_bot_chats_list_bp.route('/dashboard/bot-chats/<int:chat_id>', methods=['PUT'])
@jwt_required
@role_required('admin')
...
@admin_bot_chats_list_bp.route('/dashboard/bot-chats/<int:chat_id>', methods=['DELETE'])
@jwt_required
@role_required('admin')
...
@admin_bot_chats_list_bp.route('/dashboard/bot-chats/config', methods=['GET'])
@jwt_required
@role_required('admin')
...
@admin_bot_chats_list_bp.route('/dashboard/bot-chats/get-by-id', methods=['POST'])
@jwt_required
@role_required('admin')
...
@admin_bot_chats_list_bp.route('/dashboard/bot-chats/fetch', methods=['POST'])
@jwt_required
@role_required('admin')
...
@admin_bot_chats_list_bp.route('/dashboard/bot-chats/districts', methods=['GET'])
@jwt_required
@role_required('admin')
...
@admin_bot_chats_list_bp.route('/dashboard/bot-chats/districts', methods=['POST'])
@jwt_required
@role_required('admin')
...
@admin_bot_chats_list_bp.route('/dashboard/bot-chats/districts/<district_name>', methods=['DELETE'])
@jwt_required
@role_required('admin')
...
@admin_bot_chats_list_bp.route('/dashboard/bot-chats/<int:chat_id>/test-publish', methods=['POST'])
@jwt_required
@role_required('admin')
